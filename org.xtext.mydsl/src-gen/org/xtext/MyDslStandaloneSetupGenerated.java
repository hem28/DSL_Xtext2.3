...
public class MyDslStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new org.xtext.MyDslRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.xtext.org/MyDsl")) {
		EPackage.Registry.INSTANCE.put("http://www.xtext.org/MyDsl", org.xtext.myDsl.MyDslPackage.eINSTANCE);
	}
